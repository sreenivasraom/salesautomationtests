...
public class RequestForStock2 extends TestCase{
	@Test
	public void testa6frequestforStock() {
		...
		UtilsData.waitSeconds(2);
		LoginDetails.driver.findElement(By.xpath("//div[@class='pbBody']/div[3]/table/tbody/tr[2]/td[2]/div/input")).sendKeys("150");
		LoginDetails.driver.findElement(By.xpath("//div[@class='pbBody']/div[3]/table/tbody/tr[2]/td[4]/div/input")).sendKeys("450");
		...
		UtilsData.waitSeconds(2);
		String errorMsg = LoginDetails.driver.findElement(By.xpath("//div[@class='pbBody']/div[1]")).getText();
		System.out.println(errorMsg + " Error Data");
		if (!errorMsg.isEmpty()) {
			Assert.fail("stock limit exceeds 500");
		}
		UtilsData.waitSeconds(2);
