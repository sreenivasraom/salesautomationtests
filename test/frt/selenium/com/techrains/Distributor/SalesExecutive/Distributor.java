...
public class Distributor extends TestCase {
	@Test
	public void testa2add() {
		UtilsData.waitSeconds(2);
		LoginDetails.driver.findElement(By.linkText("Distributor")).click();
		UtilsData.waitSeconds(2);
		...
		LoginDetails.driver.findElement(By.xpath("//div[@class='pbBody']/div[3]/table/tbody/tr[1]/td[4]/input")).sendKeys("9885224356");
		LoginDetails.driver.findElement(By.xpath("//div[@class='pbBody']/div[3]/table/tbody/tr[2]/td[4]/div/input")).sendKeys("9886457623");
		...
		// Address Information
		LoginDetails.driver.findElement(By.xpath("//div[@class='pbBody']/div[5]/table/tbody/tr[1]/td[2]/div/textarea")).sendKeys("St. Louis Main Road");
		...
		LoginDetails.driver.findElement(By.xpath("//div[@class='pbBody']/div[5]/table/tbody/tr[3]/td[4]/div/input")).sendKeys("USA");
	...
	public void ClickOnZoom(String eleId) {
		LoginDetails.driver.findElement(By.xpath(eleId)).click();
